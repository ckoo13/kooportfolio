...
export default function About() {
    return (
        <Flex flexDirection='column' alignItems='center'>
            ...
            <Flex alignItems='center' justifyContent='space-between' width='100%' marginY={{base:'0', md:'20', lg:'20'}}>
                ...
                <Box width='60%'>
                    <Text>Hi, my name is Calvin Koo!</Text>
                    ...
                    <Text>Outside of work, I enjoy playing basketball with friends, going to theaters, and visiting every MLB ballpark. </Text>
